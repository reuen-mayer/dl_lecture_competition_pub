...
def main():
    ...
    test_dataset = VQADataset(df_path="drive/MyDrive/Colab Notebooks/DL2024S/Final/valid.json", image_dir="drive/MyDrive/Colab Notebooks/DL2024S/Final/valid", transform=transform, answer=False)
